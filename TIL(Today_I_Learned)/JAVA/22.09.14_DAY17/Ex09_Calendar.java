...
public class Ex09_Calendar {
	...
	public static void main(String[] args) {
		...
		//java.util.GregorianCalendar[time=1663142172576,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id="Asia/Seoul",offset=32400000,dstSavings=0,useDaylight=false,transitions=30,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2022,MONTH=8,WEEK_OF_YEAR=38,WEEK_OF_MONTH=3,DAY_OF_MONTH=14,DAY_OF_YEAR=257,DAY_OF_WEEK=4,DAY_OF_WEEK_IN_MONTH=2,AM_PM=1,HOUR=4,HOUR_OF_DAY=16,MINUTE=56,SECOND=12,MILLISECOND=576,ZONE_OFFSET=32400000,DST_OFFSET=0]

		System.out.println("년도 : " + cal.get(Calendar.YEAR));
		System.out.println("월 : " + (cal.get(Calendar.MONTH)+1)); //0월 ~ 11월
		...
		//학사 관리 시스템
		//웹 : 페이지 본수 : 200page
		//150page 날짜정보  각 페이지 하단 출력 (2022년09월14일)
		//A 친구 >> cal.get(Calendar.YEAR) + "월" ...
		//갑자기 해외 수출 .... 날짜 2022-09-14
		
		//한번만 수정해서 150페이지의 날짜 정보가 수정 될려면 
